...
@section('title')
{{ strtoupper(isset(Dits::DataPeserta()->nama)) ? Dits::DataPeserta()->nama : Auth::user()->role }} - SIM PPDB Madrasah
Kota Banda Aceh
@endsection
            ...
            <div class="row">
                <div class="col-md-auto">
                    ...
                    <span class="btn btn-primary btn-file btn-block">
                        Pilih Foto<input type="file" name="pas_foto" autocomplete="off"
                            {{ Dits::DataPeserta()->pas_foto ? '' : 'required' }}>
                    </span>
                    <a href="{{route('delete.photo.peserta')}}" onclick="return confirm_delete()"
                        class="btn btn-danger btn-block {{Dits::DataPeserta()->pas_foto ? '' : 'disabled'}}">Hapus
                        Foto</a>
                </div>
                <div class="col-sm align-self-center">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" readonly name="NIK"
                            ...
                            placeholder="123213432132" required>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="inputNisn" name="nisn"
                            ...
                            placeholder="999413233" required>
                ...
                <div class="col">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="tmp"
                            ...
                            placeholder="Contoh : Kota Banca Aceh" required>
                    </div>
                    <div class="form-group">
                        <label for="inputTTL">Tanggal Lahir Siswa<i class="text-danger"><small>*</small></i></label>
                        <input type="date" class="form-control" name="tgl"
                            value="{{Dits::DataPeserta()->tgl ? Dits::DataPeserta()->tgl : ''}}" id="inputTTL" required>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" id="hobi" name="hobi" required>
                            ...
                            <option {{Dits::selected(Dits::DataPeserta()->hobi , 'Jalan - jalan')}}
                                value="Jalan - jalan">Jalan - jalan</option>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number"
                            ...
                            class="form-control" name="anak_ke" id="anak" placeholder="Contoh : 1" required>
                    </div>
                    <div class="form-group">
                        <label for="jml_sdr">Jumlah Saudara<i class="text-danger"><small>*</small></i></label>
                        <input type="number"
                            value="{{Dits::DataPeserta()->jml_saudara ? Dits::DataPeserta()->jml_saudara : ''}}"
                            class="form-control" name="jml_saudara" id="jml_sdr" placeholder="Contoh : 2" required>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control"
                            ...
                            name="npsn_sekolah_asal" id="number" placeholder="Contoh : 10212000" required>
                    </div>
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control"
                            ...
                            name="nama_sekolah_asal" id="nm_sklh_asl" placeholder="Contoh : SDN Cakrawala" required>
                    </div>
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control"
                            ...
                            id="almt_sklh_asl" name="alamat_sekolah_asal" placeholder="Contoh : Jl. Cakrawala" required>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control"
                            ...
                            name="kartu_program" id="kp" placeholder="Contoh : KIP">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control"
                            ...
                            id="nm_ayah" name="nama_ayah" placeholder="Nama Ayah" required>
                    </div>
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control"
                            ...
                            name="nik_ayah" placeholder="Contoh : 3222206209020000" required>
                    </div>
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control"
                            ...
                            name="tmp_ayah" placeholder="Contoh : Kota Banca Aceh" required>
                    </div>
                    <div class="form-group">
                        <label for="tgl_ayah">Tanggal Lahir Ayah<i class="text-danger"><small>*</small></i></label>
                        <input type="date" class="form-control"
                            value="{{Dits::DataPeserta()->tgl_ayah ? Dits::DataPeserta()->tgl_ayah : ''}}"
                            name="tgl_ayah" id="tgl_ayah" required>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control"
                            ...
                            name="nik_ibu" placeholder="Contoh : 3222206209020000" required>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" class="form-control" id="tgl_ibu"
                            value="{{Dits::DataPeserta()->tgl_ibu ? Dits::DataPeserta()->tgl_ibu : ''}}" name="tgl_ibu"
                            required>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control"
                            ...
                            name="kontak_peserta" id="kontak" placeholder="Contoh : 08128888xxxx">
                    </div>
                    <div class="form-group">
                        <label for="email">Alamat Email</label>
                        <input type="email" class="form-control" value="{{Auth::user()->email}}" id="email"
                            placeholder="contoh@email.com" readonly>
        ...
        <div class="table-resposive">
            <div class="form-group">
                ...
                <a href="{{Dits::pdfViewer(asset(Dits::DataPeserta()->akte))}}" target="_blank"
                    class="btn btn-info btn-sm float-right mt-2 mb-3">Lihat File</a>
                <a href="{{route('delete-document' , ['akte' , Dits::DataPeserta()->NIK])}}"
                    onclick="return confirm_delete()" class="btn btn-danger btn-sm float-right mt-2 mb-3 mr-2">Hapus
                    File</a>
                @else
