...
<nav aria-label="bc">
    <ol class="bc">
        ...
        <li class="bc-item active" aria-current="page">Bank Soal</li>
    </ol>
</nav>
@endsection
...
<div class="card">
    <div class="card-body">
        <a href="{{route('bank-soal.create')}}" class="btn btn-info btn-sm float-right mb-5"><i class="fas fa-plus"></i>
            Tambah Bank Soal</a>
