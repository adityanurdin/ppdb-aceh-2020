            ...
            <div class="card ml-auto">
              <div class="card-body">
                ...
                <div class="form-check">
                  <input class="form-check-input" required name="jawaban[]" {{Dits::selected(isset($jawaban_peserta->jawaban) ? $jawaban_peserta->jawaban : '' , 'a' , 'checked')}}  type="radio" name="exampleRadios" id="exampleRadios1" value="a">
                  <label class="form-check-label" for="exampleRadios1">
                    A. {{ $soal->a }}
                  </label>
                </div>
                <div class="form-check">
                  <input class="form-check-input" required name="jawaban[]" {{Dits::selected(isset($jawaban_peserta->jawaban) ? $jawaban_peserta->jawaban : '' , 'b' , 'checked')}}  type="radio" name="exampleRadios" id="exampleRadios2" value="b">
                  <label class="form-check-label" for="exampleRadios2">
                    B. {{ $soal->b }}
                  </label>
                </div>
                <div class="form-check">
                  <input class="form-check-input" required name="jawaban[]" {{Dits::selected(isset($jawaban_peserta->jawaban) ? $jawaban_peserta->jawaban : '' , 'c' , 'checked')}}  type="radio" name="exampleRadios" id="exampleRadios3" value="c">
                  <label class="form-check-label" for="exampleRadios3">
                    C. {{ $soal->c }}
                  </label>
                </div>
                <div class="form-check">
                  <input class="form-check-input" required name="jawaban[]" {{Dits::selected(isset($jawaban_peserta->jawaban) ? $jawaban_peserta->jawaban : '' , 'd' , 'checked')}} type="radio" name="exampleRadios" id="exampleRadios4" value="d">
