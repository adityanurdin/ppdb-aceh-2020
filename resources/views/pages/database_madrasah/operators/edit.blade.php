...
<nav aria-label="bc">
    <ol class="bc">
        ...
        <li class="bc-item active" aria-current="page">Edit Operator Madrasah</li>
    </ol>
</nav>
@endsection
...
<div class="row">
    ...
    <div class="col-md-8">
        <div class="card">
            <div class="card-body">
                <form action="{{ route('madrasah.operators.update' , Dits::encodeDits($data->uuid))}}" method="POST"
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" value="{{isset($data) ? $data->kontak_operator : ''}}" name="kontak_operator"
                            id="" class="form-control  @error('kontak_operator') is-invalid @enderror" autocomplete="off"
                            maxlength="30" >
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" value="{{isset($data) ? $data->email_operator : ''}}" name="email_operator"
                            id="" class="form-control  @error('email_operator') is-invalid @enderror" autocomplete="off"
                            maxlength="100" >
